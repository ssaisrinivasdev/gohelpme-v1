    ...
    <div className="bg-slate-100">
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="container max-w-4xl px-6 py-10 mx-auto">
          <h1 class="text-4xl font-semibold text-center text-gray-800 dark:text-white">
          ...
          <div class="mt-12 space-y-8">
            ...
            <div class="border-2 border-gray-100 rounded-lg dark:border-gray-700">
              <button class="flex items-center justify-between w-full p-8">
                ...
                <span class="text-white bg-color1 rounded-full">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-6 h-6"
                    fill="none"
            ...
            <div class="border-2 border-gray-100 rounded-lg dark:border-gray-700">
              <button class="flex items-center justify-between w-full p-8">
                <h1 class="font-semibold text-gray-700 dark:text-white">
                  How many daya will it take for my fundraiser to be approved?
                </h1>
