      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-12 mx-auto">
          ...
          <div class="grid grid-cols-1 gap-8 mt-8 lg:mt-16 md:grid-cols-2 xl:grid-cols-3">
            <div>
              <div class="inline-block p-3 text-white bg-color1 rounded-lg">
                <svg
            ...
            <div>
              ...
              <div>
                <h1 class="text-xl font-semibold text-gray-700 dark:text-white">
                  What do i need to signup as a charity?
                </h1>
            ...
            <div>
              ...
              <div>
                <h1 class="text-xl font-semibold text-gray-700 dark:text-white">
                  What to write for better and faster fundraising?
                </h1>
            ...
            <div>
              ...
              <div>
                <h1 class="text-xl font-semibold text-gray-700 dark:text-white">
                  What are the gohelpme policies?
                </h1>
            ...
            <div>
              ...
              <div>
                <h1 class="text-xl font-semibold text-gray-700 dark:text-white">
                  What is the pricing of GoHelpMe?
                </h1>
