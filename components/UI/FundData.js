  ...
  async function donationHandler() {
    ...
    if (fund.donations) {
      donations = fund.donations.map((data) => {
        return <Donations data={data} key={data.donator_name} />;
      });
          ...
          <div className="xl:mx-20">
            ...
            {fund.highest_donated[0] ? (
              <>
                ...
                <Donations
                  data={fund.highest_donated[0]}
                  key={fund.highest_donated[0]?.donator_name}
                />
              </>
            ) : (
              ""
            ...
            {fund.first_donated[0] ? (
              <>
                ...
                <Donations
                  data={fund.first_donated[0]}
                  key={fund.first_donated[0]?.donator_name}
                />
              </>
            ) : (
              ""
            ...
            {fund.recent_donated[0] ? (
              <>
                ...
                <Donations
                  data={fund.recent_donated[0]}
                  key={fund.recent_donated[0]?.donator_name}
                />
              </>
            ) : (
              ""
