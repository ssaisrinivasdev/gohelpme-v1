      ...
      <footer class="bg-white mt-10">
        <div class="container p-6 mx-auto">
          <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
              <div class="px-6">
                ...
                <p class="max-w-sm mt-2 text-gray-500 ">
                  Join thousands of people generating funds for help to the
                  needy.
                </p>
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1 mb-10">
              <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <div>
                  <h3 class="text-gray-700 uppercase ">Learn more</h3>
                  <a
                    href="#"
                    class="block mt-2 text-sm text-gray-600  hover:underline"
                  >
                ...
                <div>
                  <h3 class="text-gray-700 uppercase ">Resources</h3>
                  <a
                    href="#"
                    class="block mt-2 text-sm text-gray-600 hover:underline"
                  >
          ...
          <div>
            <p class="text-center text-gray-500 ">
              © GoHelpMe 2022 - All rights reserved
            </p>
          </div>
        </div>
      </footer>
