  ...
  return (
    ...
    >
      <div className="flex mx-3 gap-2">
        <div className="xl:w-[150px] xl:mx-auto">
          <select
            {...register("category")}
            className=" w-36 py-3 text-gray-500 border rounded-md outline-none bg-gray-50 focus:bg-white"
          >
        ...
        <div className="w-[300px] xl:w-[450px]">
      ...
      <input
        type="submit"
        value="Search"
        class="max-md:mx-3 xl:w-[200px] px-4 py-2 tracking-wide text-white transition-colors duration-300 transform bg-color1 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600"
      />
    </form>
  );
}
